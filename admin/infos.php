...
if(isset($_POST["valider"])){
  mysql_query("update infos set tel = '".($_POST["tel"])."',email = '".($_POST["email"])."',fb_page = '".($_POST["fb"])."',twitter_page = '".($_POST["tw"])."',siege_social = '".($_POST["ss"])."',instagram = '".($_POST["instagram"])."'");
                ...
                <form role="form" method="post" action="infos.php">
                      ...
                      <div class="box-body">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Entrer le numero de Téléphone *</label>
