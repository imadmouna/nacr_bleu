...
if(isset($_POST["libelle"]) and $_POST["libelle"] and isset($_POST["id_cat"]) and $_POST["id_cat"]){
  mysql_query("update categorie set libelle = '".utf8_encode(addslashes($_POST["libelle"]))."' where id_cat=".$_POST["id_cat"]);
  echo "<script language='javascript'>document.location.href='modifierCat.php?id=".$_POST["id_cat"]."';</script>";
}
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <a href="cats.php">Cat&eacute;gories</a>
        ...
        <section class="content">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Modifier cat&eacute;gorie: <i><?php echo $t[1]; ?></i></h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="modifierCat.php?id=<?php echo $t[0]; ?>">
                  <div class="box-body">

                    <div class="form-group">
                      <label for="exampleInputEmail1">Libelle *</label>
                      <input class="form-control" name="libelle" placeholder="Entrez le libelle" value="<?php echo $t[1]; ?>" required>
