...
if(isset($_POST["editor1"]) and $_POST["editor1"]){
  mysql_query("update apropos set texte = '".utf8_encode(addslashes($_POST["editor1"]))."'");
  echo "<script language='javascript'>document.location.href='apropos.php';</script>";
}
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="apropos.php">
                  <div class="box-body">

                    <div class="form-group">
                      <label for="exampleInputEmail1">Description *</label>
                      <textarea id="editor1" name="editor1" rows="10" cols="80" required><?php $tt = mysql_fetch_array(mysql_query("select texte from apropos")); echo stripslashes(utf8_decode($tt[0]));?></textarea>
                    </div>
